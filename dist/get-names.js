...
exports.getaanAccountAddress = exports.getaanNames = void 0;
...
exports.getaanNames = getaanNames;
var getaanAccountAddress = function (aanName) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          boxesRequest = env_1.algodClient.getApplicationBoxByName(
            env_1.APP_ID,
            Buffer.from(aanName)
          );
          return [4 /*yield*/, boxesRequest.do()];
...
exports.getaanAccountAddress = getaanAccountAddress;
