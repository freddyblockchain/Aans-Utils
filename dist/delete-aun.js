...
exports.deleteaanTransaction = void 0;
var algosdk_1 = __importStar(require("algosdk"));
var env_1 = require("./env");
var deleteaanTransaction = function (name, signingAddress) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          args = [];
          delete_aan = "delete_aan";
          box_key = name;
          boxes = [
            {
              appIndex: env_1.APP_ID,
              name: new Uint8Array(Buffer.from(box_key)),
            },
          ];
        ...
        case 3:
          err_1 = _a.sent();
          console.error("Creation of delete aan failed", err_1);
          return [3 /*break*/, 4];
        case 4:
          return [2 /*return*/];
      }
...
exports.deleteaanTransaction = deleteaanTransaction;
